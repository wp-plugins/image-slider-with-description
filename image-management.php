...
<div class="wrap">
  ...
  <div class="tool-box">
    ...
    <form name="frm_ImgSlider_display" method="post">
     ...
     <br /><br />  Check official website <a target="_blank" href="http://www.gopipulse.com/work/2011/11/04/wordpress-plugin-image-slider-with-description/">www.gopipulse.com</a> for live demo and more info.
</form>
  </div>
</div>