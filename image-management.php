...
<div class="wrap">
  ...
  <div class="tool-box">
    ...
    <form name="frm_ImgSlider_display" method="post">
     ...
     <br /> Note: Check official website <a target="_blank" href="http://www.gopiplus.com/work/2011/11/04/wordpress-plugin-image-slider-with-description/">www.gopiplus.com</a> for live demo and more help.
</form>
  </div>
</div>