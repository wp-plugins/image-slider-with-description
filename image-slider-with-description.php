...
function ImgSlider_admin_options() 
{
	...
	echo '</form>';
	echo '<br>Note: Check official website <a target="_blank" href="http://www.gopiplus.com/work/2011/11/04/wordpress-plugin-image-slider-with-description/">www.gopiplus.com</a> for live demo and more help.<br>';
	echo '</div><br>';
}
