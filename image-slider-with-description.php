...
function ImgSlider_admin_options() 
{
	...
	echo '<br>Check official website <a target="_blank" href="http://www.gopipulse.com/work/2011/11/04/wordpress-plugin-image-slider-with-description/">www.gopipulse.com</a> for live demo and more info.<br>';
	echo '</div><br>';
}
